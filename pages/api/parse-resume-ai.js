  ...
  form.parse(req, async (err, fields, files) => {
    ...
    try {
      ...
      try {
        ...
        throw new Error("Invalid GOOGLE_CREDENTIALS format in Vercel.");
      }
      ...
      const prompt = `Extract details from this resume text. Return ONLY a valid JSON object. Keys: name, mobile, email, location, experienceYears, experienceMonths, ctcLakhs, ctcThousands, noticePeriod, headline, summary, skills (comma separated string). Text: ${pdfData.text.substring(0, 15000)}`;
