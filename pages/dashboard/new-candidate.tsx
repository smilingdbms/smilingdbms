...
const indianLocations = {
  "Andaman & Nicobar": ["Port Blair"], "Andhra Pradesh": ["Visakhapatnam", "Vijayawada", "Guntur", "Nellore", "Tirupati"], "Arunachal Pradesh": ["Itanagar"], "Assam": ["Guwahati", "Silchar", "Dibrugarh"], "Bihar": ["Patna", "Gaya", "Bhagalpur", "Muzaffarpur"], "Chandigarh": ["Chandigarh"], "Chhattisgarh": ["Raipur", "Bhilai", "Bilaspur"], "Delhi": ["New Delhi", "Dwarka", "Rohini", "Janakpuri", "Vasant Kunj"], "Goa": ["Panaji", "Margao", "Vasco da Gama"], "Gujarat": ["Ahmedabad", "Surat", "Vadodara", "Rajkot", "Gandhinagar", "Bhavnagar"], "Haryana": ["Gurugram", "Faridabad", "Panipat", "Ambala", "Rohtak"], "Himachal Pradesh": ["Shimla", "Dharamshala", "Mandi"], "Jammu & Kashmir": ["Srinagar", "Jammu"], "Jharkhand": ["Ranchi", "Jamshedpur", "Dhanbad", "Bokaro"], "Karnataka": ["Bengaluru", "Mysuru", "Hubballi", "Mangaluru", "Belagavi"], "Kerala": ["Kochi", "Thiruvananthapuram", "Kozhikode", "Thrissur", "Kollam"], "Madhya Pradesh": ["Indore", "Bhopal", "Gwalior", "Jabalpur", "Ujjain"], "Maharashtra": ["Mumbai", "Pune", "Nagpur", "Nashik", "Thane", "Navi Mumbai", "Aurangabad", "Kolhapur"], "Manipur": ["Imphal"], "Meghalaya": ["Shillong"], "Mizoram": ["Aizawl"], "Nagaland": ["Dimapur", "Kohima"], "Odisha": ["Bhubaneswar", "Cuttack", "Rourkela", "Berhampur"], "Puducherry": ["Puducherry"], "Punjab": ["Ludhiana", "Amritsar", "Jalandhar", "Patiala", "Mohali"], "Rajasthan": ["Jaipur", "Jodhpur", "Udaipur", "Kota", "Bikaner", "Ajmer"], "Sikkim": ["Gangtok"], "Tamil Nadu": ["Chennai", "Coimbatore", "Madurai", "Tiruchirappalli", "Salem", "Tirunelveli"], "Telangana": ["Hyderabad", "Warangal", "Nizamabad", "Karimnagar"], "Tripura": ["Agartala"], "Uttar Pradesh": ["Noida", "Greater Noida", "Ghaziabad", "Lucknow", "Kanpur", "Agra", "Varanasi", "Prayagraj", "Meerut"], "Uttarakhand": ["Dehradun", "Haridwar", "Roorkee", "Haldwani"], "West Bengal": ["Kolkata", "Howrah", "Durgapur", "Siliguri", "Asansol"]
};
const allCities = Object.values(indianLocations).flat();

const rolesList = ["Software Developer", "Frontend Developer", "Backend Developer", "Full Stack Developer", "Mobile App Developer", "QA Engineer", "Automation Tester", "DevOps Engineer", "Cloud Architect", "Data Scientist", "Data Analyst", "Data Engineer", "Machine Learning Engineer", "AI Engineer", "Product Manager", "Project Manager", "Scrum Master", "Business Analyst", "UI/UX Designer", "Graphic Designer", "HR Executive", "HR Manager", "Talent Acquisition Specialist", "IT Recruiter", "Non-IT Recruiter", "Business Development Executive", "Business Development Manager", "Sales Executive", "Sales Manager", "Account Executive", "Marketing Executive", "Digital Marketing Specialist", "SEO Specialist", "Content Writer", "Copywriter", "Social Media Manager", "Financial Analyst", "Accountant", "Chartered Accountant", "Operations Executive", "Operations Manager", "Supply Chain Manager", "Customer Support Executive", "Technical Support Engineer", "System Administrator", "Network Engineer", "Legal Advisor", "Medical Officer", "Teacher/Professor", "Other"];

const industriesList = ["Information Technology (IT)", "Software Services", "Hardware & Networking", "Internet/E-commerce", "Recruitment/Staffing", "Human Resources", "BPO/KPO/ITES", "Telecommunications", "E-Learning/EdTech", "Education/Training", "Financial Services", "Banking", "Insurance", "Accounting/Auditing", "Retail", "FMCG", "Manufacturing", "Automobile", "Aviation/Aerospace", "Healthcare/Hospitals", "Pharmaceuticals", "Biotechnology", "Real Estate", "Construction/Engineering", "Logistics/Supply Chain", "Travel/Tourism", "Media/Entertainment", "Advertising/PR", "Agriculture/Dairy", "Energy/Power", "Oil & Gas", "Consulting", "Legal", "NGO/Social Services", "Government/Defense", "Other"];

const courseBranchMap = {
  "B.Tech/B.E": ["Computer Science", "Information Technology", "Electronics & Communication", "Electrical", "Mechanical", "Civil", "Chemical", "Aerospace", "Automobile", "Biotechnology", "Instrumentation", "Other"], "M.Tech/M.E": ["Computer Science", "VLSI", "Embedded Systems", "Structural", "Thermal", "Power Systems", "Other"], "BCA": ["General", "Cloud Computing", "Data Science", "AI & ML"], "MCA": ["General", "Software Engineering", "AI", "Network Security"], "B.Sc": ["Computer Science", "IT", "Mathematics", "Physics", "Chemistry", "Biology", "Botany", "Zoology", "Nursing", "Agriculture", "Other"], "M.Sc": ["Computer Science", "IT", "Mathematics", "Physics", "Chemistry", "Data Science", "Other"], "BBA": ["General", "HR", "Finance", "Marketing", "International Business"], "MBA/PGDM": ["Human Resources", "Marketing", "Finance", "Operations", "IT", "Supply Chain", "International Business", "Healthcare Management", "Other"], "B.Com": ["General", "Honours", "Accounting & Finance", "Taxation", "Computer Applications"], "M.Com": ["General", "Accounting", "Finance"], "BA": ["English", "History", "Economics", "Political Science", "Psychology", "Sociology", "Other"], "MA": ["English", "History", "Economics", "Political Science", "Psychology", "Other"], "Diploma": ["Mechanical", "Civil", "Electrical", "Computer Science", "Electronics", "Other"], "Ph.D": ["Engineering", "Science", "Arts", "Management", "Commerce"], "CA": ["General"], "CS": ["General"], "ICWA (CMA)": ["General"], "LLB": ["General", "Corporate Law", "Criminal Law", "IPR"], "LLM": ["Corporate Law", "Criminal Law", "Constitutional Law"], "MBBS": ["General Medicine"], "BDS": ["Dental"], "B.Pharm": ["General"], "M.Pharm": ["Pharmaceutics", "Pharmacology", "Quality Assurance"], "B.Des": ["Fashion", "Interior", "Graphic", "Industrial", "Product"], "M.Des": ["Fashion", "Interior", "Industrial"], "B.Arch": ["Architecture"], "M.Arch": ["Architecture"], "B.Ed": ["General"], "M.Ed": ["General"], "BHM": ["Hotel Management", "Culinary Arts"], "BFA": ["Painting", "Applied Arts", "Sculpture"], "MFA": ["Painting", "Applied Arts"], "MSW": ["Social Work"], "B.V.Sc": ["Veterinary Science"], "M.V.Sc": ["Veterinary Science"], "Other": ["General"]
};
...
export default function NewCandidate() {
  ...
  // Starting with 1 empty row for inline addition
  ...
  const suggestedSkills = ['React.js', 'Next.js', 'TypeScript', 'SQL', 'Node.js', 'Python', 'Java', 'C++', 'Spring Boot', 'AWS', 'Docker', 'Lead Generation', 'Client Acquisition', 'B2B Sales', 'CRM', 'Cold Calling', 'Negotiation', 'SEO', 'Agile', 'JIRA'];
  ...
  const handleSave = async () => {
    ...
    // Clean empty inline rows before saving
    ...
    const { error } = await supabase.from('placements').insert([{
      ...
      employments: cleanEmp, educations: cleanEdu, preferences, resume_url: cvUrl, status: 'New'
    }]);
