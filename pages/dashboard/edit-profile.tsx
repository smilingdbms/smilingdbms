      ...
      <div style={{maxWidth:820,margin:'0 auto',padding:'20px 16px'}}>
        ...
        <div style={SECTION}>
          ...
          <div style={{display:'flex',gap:8,flexWrap:'wrap',marginBottom:8}}>
            {[
              {key:'student', icon:'🎓', title:'Student', sub:'Currently studying', color:'#f59e0b'},
              {key:'fresher', icon:'🌱', title:'Fresher', sub:'Graduated · no job yet', color:'#3dd68c'},
              {key:'professional', icon:'💼', title:'Professional', sub:'Has work experience', color:'#6c8cff'},
            ].map(opt=>{
