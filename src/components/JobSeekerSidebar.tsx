...
export default function JobSeekerSidebar({
  ...
  return (
    <>
      <style>{`
        .js-nav{background:var(--bg2);border-bottom:1px solid rgba(255,255,255,0.06);padding:10px 16px;display:flex;align-items:center;justify-content:space-between;position:sticky;top:0;z-index:100;gap:8px}
        ...
        .js-logo-sub{font-size:9px;color:var(--mu2);letter-spacing:1.5px;text-transform:uppercase}
        .js-nav-links{display:flex;gap:4px;align-items:center}
        .js-nav-btn{background:transparent;border:1px solid rgba(255,255,255,0.06);border-radius:10px;padding:8px 14px;font-size:13px;font-weight:500;cursor:pointer;font-family:inherit;color:var(--mu);transition:all 0.15s;white-space:nowrap}
        ...
        .js-back-btn{background:none;border:none;color:var(--mu);cursor:pointer;font-size:18px;padding:6px;border-radius:8px;display:flex;align-items:center;transition:all 0.15s}
        .js-back-btn:hover{background:rgba(255,255,255,0.06);color:var(--tx)}
        .js-hamburger{display:none;background:none;border:1px solid rgba(255,255,255,0.08);color:var(--tx);cursor:pointer;font-size:20px;padding:6px 10px;border-radius:8px}
        ...
        .js-vibe-btn{padding:5px 8px;border-radius:8px;border:none;cursor:pointer;font-size:13px;background:transparent;color:var(--mu2);font-family:inherit;transition:all 0.15s}
        ...
        .js-drawer{position:fixed;top:0;right:-280px;width:280px;height:100vh;background:var(--bg2);border-left:1px solid rgba(255,255,255,0.08);z-index:201;transition:right 0.25s ease;padding:20px 16px;display:flex;flex-direction:column;overflow-y:auto}
        ...
        .js-drawer-close{background:none;border:none;color:var(--mu);cursor:pointer;font-size:22px;padding:4px}
        .js-drawer-nav{display:flex;flex-direction:column;gap:4px;margin-bottom:20px}
        .js-drawer-link{display:flex;align-items:center;gap:10px;padding:12px 14px;border-radius:10px;cursor:pointer;font-size:14px;font-weight:500;color:var(--mu);transition:all 0.15s;border:none;background:none;width:100%;text-align:left;font-family:inherit}
        ...
        .js-drawer-section{font-size:11px;font-weight:600;color:var(--mu2);text-transform:uppercase;letter-spacing:1px;padding:8px 14px;margin-top:8px}
      ...
      <div className={`js-drawer ${menuOpen ? 'open' : ''}`}>
        ...
        <div className="js-drawer-header">
          <div>
            ...
            <div style={{ fontSize: 12, color: 'var(--mu2)' }}>Job Seeker</div>
          </div>
