...
export default function DashboardNav({ userName = '', userRole = '', companyName = '' }: DashboardNavProps) {
  ...
  function applyTheme(dark: boolean) {
    ...
    if (dark) {
      ...
      root.style.setProperty('--bg2', '#161921')
      root.style.setProperty('--bg3', '#1e2230')
      root.style.setProperty('--bg4', '#282d3a')
      root.style.setProperty('--tx', '#e8eaf0')
      root.style.setProperty('--tx2', '#c8cad0')
      root.style.setProperty('--mu', '#7a7f90')
      root.style.setProperty('--mu2', '#505468')
      ...
      root.style.setProperty('--tx', '#1a1d27')
      root.style.setProperty('--tx2', '#374151')
      root.style.setProperty('--mu', '#6b7280')
      root.style.setProperty('--mu2', '#9ca3af')
